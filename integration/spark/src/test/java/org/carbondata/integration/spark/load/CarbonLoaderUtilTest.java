...
public class CarbonLoaderUtilTest {
    ...
    public void nodeBlockMapping() throws Exception {
        ...
        Map<String, List<TableBlockInfo>> outputMap = CarbonLoaderUtil.NodeBlockMapping
                (inputMap, 4, 4);
    ...
    public void nodeBlockMappingTestWith5blocks3nodes() throws Exception {
        ...
        TableBlockInfo block1 = new TableBlockInfo("part-0-0-1462341987000", 123, 1,
                new String[]{"sdf"}, 111);
        TableBlockInfo block2 = new TableBlockInfo("part-1-0-1462341987000", 123, 2,
                new String[]{"sdf"}, 111);
        TableBlockInfo block3 = new TableBlockInfo("part-2-0-1462341987000", 123, 3,
                new String[]{"sdf"}, 111);
        TableBlockInfo block4 = new TableBlockInfo("part-3-0-1462341987000", 123, 4,
                new String[]{"sdf"}, 111);
        TableBlockInfo block5 = new TableBlockInfo("part-4-0-1462341987000", 123, 5,
                new String[]{"sdf"}, 111);
    ...
    public void nodeBlockMappingTestWith6Blocks4nodes() throws Exception {
        ...
        TableBlockInfo block4 = new TableBlockInfo("part-3-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
        TableBlockInfo block5 = new TableBlockInfo("part-4-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
        TableBlockInfo block6 = new TableBlockInfo("part-5-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
    ...
    public void nodeBlockMappingTestWith10Blocks4nodes() throws Exception {
        ...
        TableBlockInfo block1 = new TableBlockInfo("part-1-0-1462341987000", 123, 1,
                new String[]{"sdf"},
                111);
        TableBlockInfo block2 = new TableBlockInfo("part-2-0-1462341987000", 123, 2,
                new String[]{"sdf"},
                111);
        TableBlockInfo block3 = new TableBlockInfo("part-3-0-1462341987000", 123, 3,
                new String[]{"sdf"},
                111);
        TableBlockInfo block4 = new TableBlockInfo("part-4-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
        TableBlockInfo block5 = new TableBlockInfo("part-5-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
        TableBlockInfo block6 = new TableBlockInfo("part-6-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
        TableBlockInfo block7 = new TableBlockInfo("part-7-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
        TableBlockInfo block8 = new TableBlockInfo("part-8-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
        TableBlockInfo block9 = new TableBlockInfo("part-9-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
        TableBlockInfo block10 = new TableBlockInfo("part-10-0-1462341987000", 123, 4,
                new String[]{"sdf"},
                111);
